...
# ACCOUNT_ID = input("Nhập account_id: ")
DEVICE_SERIAL = "d4c5afc7"
...
def get_account_id():
    ...
    response = requests.get('https://gateway.golike.net/api/tiktok-account', headers=headers, impersonate="safari_ios")
